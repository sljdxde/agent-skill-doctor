...
### Fixed
- Reconciled missing skills, stale findings, and obsolete duplicate groups during diagnosis.
- Stopped treating skill version metadata as an upstream git ref.
- Corrected project-local Agent directory classification.
- Added target filtering to apply --dry-run and refreshed finding relationships.
