...
| 分类 | 说明 | 僵尸保护 |
|------|------|---------|
| **官方** | anthropics/openai/google 等官方来源 | 分数归零（完全保护） |
| **插件** | obra/superpowers 等插件来源 | 分数 ×0.5 |
| **第三方** | 其他来源或未知来源 | 分数 ×0.75 |
...
#     "members": [
#       { "slug": "browser", "local_path": "~/.claude/skills/skills/browser", "role": "candidate" },
#       { "slug": "browser", "local_path": "~/.agents/skills/skills/browser", "role": "canonical" }
#     ]
#   }
# ]

# 3. 根据报告删除冗余副本（保留 canonical 版本）
...
# 6. 生成僵尸清理提示词
agent-skill-doctor fix --type zombie --lang zh
# 将输出的提示词复制给 Agent，Agent 会帮你清理僵尸技能
```
...
# 报告中的扫描概览会显示：
# - 官方（绿色）：anthropics/openai/google 等官方技能
# - 插件（紫色）：obra/superpowers 等插件技能
# - 第三方（黄色）：其他来源的技能
